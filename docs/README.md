...
<H3>Research the Reactive REST Web Service</H3>
<P>
...
The project <b>Study03</b> implements one ot them, the "<i>Functional Endpoints</i>" programming model.
</P>

<P><IMG src="images/MermaidFlowchart.png" height="350" width="675"/><BR>
<img src="images/blackArrowUp.png">
<I>The flowchart with Docker containers '<b>study03</b>' and '<b>redis</b>'.</I></P>

<P>
The <b>Redis</b> is the in-memory data structure store.<br>
...
<P><IMG src="images/MermaidClassDiagram.png" height="440" width="590"/><BR>
<img src="images/blackArrowUp.png">
...
<img src="images/orangeSquare.png"><img src="images/spacer-32.png">start the container with the SpringBoot server.<br>
...
<P>
<IMG src="images/ScreenshotDockerContainer.png" height="365" width="950"/><BR>
<img src="images/blackArrowUp.png">
...
<P>Action:<br>
<img src="images/orangeHR-500.png"><br>
<img src="images/orangeSquare.png"> 1. With the URL <a href="http://localhost:8280">http://localhost:8280</a> open in the web browser the 
<a href="https://github.com/k1729p/Study03/blob/main/src/main/resources/static/index.html">home page</a>.<br>
<img src="images/orangeSquare.png"> 2. On this
...
<IMG src="images/ScreenshotHomePage.png" height="315" width="985"/><BR>
<img src="images/blackArrowUp.png">
...
<P>
The handler method:
<a href="https://github.com/k1729p/Study03/blob/main/src/main/java/kp/company/handlers/DepartmentHandler.java#L46">
kp.company.handlers.DepartmentHandler::handleDepartments</a>.<br>
</P>
<P><IMG src="images/GetAllDepartments.png" height="480" width="300"/><BR>
<img src="images/blackArrowUp.png">
...
<P>
The handler method:
<a href="https://github.com/k1729p/Study03/blob/main/src/main/java/kp/company/handlers/DepartmentHandler.java#L67">
kp.company.handlers.DepartmentHandler::handleDepartmentByDepartmentKey</a>.<br>
</P>
<P><IMG src="images/GetDepartmentByDepartmentKey.png" height="235" width="275"/><BR>
<img src="images/blackArrowUp.png">
...
<P>
The handler method:
<a href="https://github.com/k1729p/Study03/blob/main/src/main/java/kp/company/handlers/EmployeeHandler.java#L47">
kp.company.handlers.EmployeeHandler::handleEmployeeByDepartmentKeyAndNames</a>.<br>
</P>
<P><IMG src="images/GetEmployeeByDepartmentKeyAndEmployeeNames.png" height="80" width="220"/><BR>
<img src="images/blackArrowUp.png">
...
<P>
The handler method:
<a href="https://github.com/k1729p/Study03/blob/main/src/main/java/kp/company/handlers/TeamHandler.java#L50">
kp.company.handlers.TeamHandler::handleTeams</a>.<br>
</P>
<P><IMG src="images/GetAllTeamsAndScores.png" height="545" width="130"/><BR>
<img src="images/blackArrowUp.png">
...
<P>
The handler method:
<a href="https://github.com/k1729p/Study03/blob/main/src/main/java/kp/company/handlers/TeamHandler.java#L71">
kp.company.handlers.TeamHandler::handleTeamsRangeByScore</a>.<br>
</P>
<P><IMG src="images/GetTeamsAndScoresByRanges.png" height="345" width="135"/><BR>
<img src="images/blackArrowUp.png">
...
<P>
The handler method:
<a href="https://github.com/k1729p/Study03/blob/main/src/main/java/kp/company/handlers/TeamHandler.java#L102">
kp.company.handlers.TeamHandler::handleTeamRankById</a>.<br>
</P>
<P><IMG src="images/GetTeamRankByTeamId.png" height="30" width="30"/><BR>
<img src="images/blackArrowUp.png">
...
The method 
<a href="https://github.com/k1729p/Study03/blob/main/src/main/java/kp/client/WebClientLauncher.java#L67">

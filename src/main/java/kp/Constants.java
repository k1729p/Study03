...
public final class Constants {
	...
	public static final IntFunction<String> DEP_KEY_FUN = depIndex -> String.format("K-DEP-%d", depIndex);
	public static final IntFunction<String> DEP_NAME_FUN = depIndex -> String.format("D-Name-%d", depIndex);

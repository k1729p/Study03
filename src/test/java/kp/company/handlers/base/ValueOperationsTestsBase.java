...
public abstract class ValueOperationsTestsBase extends HandlersTestsBase {
     ...
     */
    @MockitoBean
    protected ReactiveRedisOperations<@NonNull String, @NonNull Department> reactiveRedisOperations;

    /**
     * The {@link ReactiveValueOperations}.
     */
    @MockitoBean
    protected ReactiveValueOperations<@NonNull String, @NonNull Department> reactiveValueOperations;

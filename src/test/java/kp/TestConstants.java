...
public final class TestConstants {
	...
	public static final String DEP_LIST_NULL_ERR_MSG = "List os departments is null";
	...
	public static final String EMP_FNAME_ERR_MSG = "Bad employee first name";
	public static final String EMP_LNAME_ERR_MSG = "Bad employee last name";
	public static final String EMP_LIST_NULL_ERR_MSG = "List os employees is null";
	public static final String EMP_LIST_SIZE_ERR_MSG = "Bad employe list size";
	public static final String EMP_LIST_CONTENT_ERR_MSG = "Bad employe list content";
